...
def train():
    ...
    checkpoint_path = chkpt_dir + "PPO_{}_{}_{}.pth".format(env_name, random_seed, run_num)
    ...
    print("--------------------------------------------------------------------------------------------")
    print("max training timesteps : ", max_timesteps)
    ...
    ppo_agent = PPO(state_dim, action_dim, lr_actor, lr_critic, gamma, K_epochs, eps_clip, is_continuous, action_std)
