...
from PPO_discrete.ppo import PPO_Discrete
...
def main(args, env_name):
    ...
    init_info = (
        ...
        f"lr_actor_limit: {args.lr_actor_limit}, lr_critic_limit: {args.lr_critic_limit} \n"
    ...
    plt.plot(train_timestep_list, smoothed_train_reward, color='blue', alpha=0.7, linewidth=1, label='EMA (alpha=0.05)')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--max_timesteps', type=int, default=int(80e4), help='Max steps for training')
    ...
    parser.add_argument('--lr_actor_limit', type=float, default=5e-5, help='Decay limit of lr_actor')
    parser.add_argument('--lr_critic_limit', type=float, default=1e-4, help='Decay limit of lr_critic')
    ...
    parser.add_argument('--entropy_coef', type=float, default=1e-2, help='Coefficient of entropy loss')
    parser.add_argument('--entropy_decay', type=float, default=0.98, help='Coefficient of entropy loss')
