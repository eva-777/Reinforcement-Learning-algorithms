...
github: https://github.com/Guowei-Zou/simple_mappo/blob/main/train_weight_simple_spread.py
'''
import os
import shutil
import torch
...
with tqdm(total=total_episodes, desc="Training") as pbar:
    for episode in range(1, total_episodes + 1):
        ...
        while not terminal:
            ...
            actions, action_probs = mappo.take_action(state_list)
            # 将动作列表转换为字典
            ...
            for i, agent in enumerate(agent_order):
                ...
                buffers[i]['action_probs'].append(action_probs[i])
